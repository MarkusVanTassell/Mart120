    ...
    class myShape{
      constructor(xShape,yShape,sideLength,colorValue){
        this.xShape = xShape;
        this.yShape = yShape;
      ...
      display()
      {
        fill(this.colorValue, 100, 100)
        square(this.xShape,this.yShape,this.sideLength)
      }
      
    }
    
    var bigSquare = new myShape(400, 400, 150, 255)
    var babySquare = new myShape(500, 500, 40, 100)
    var daddySquare = new myShape(30, 600, 200, 0)
